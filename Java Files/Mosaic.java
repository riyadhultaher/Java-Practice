...
public class Mosaic extends Application {
    ...
    public void start(Stage stage) {
        ...
        if (params.size() != 4)
            ...
            canvas = new MosaicCanvas(java.lang.Integer.parseInt(params.get(0)),java.lang.Integer.parseInt(params.get(1)),
                    java.lang.Integer.parseInt(params.get(2)),java.lang.Integer.parseInt(params.get(3)));
        if (!use3DEffect)
